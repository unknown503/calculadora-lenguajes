...
import { Concatenación } from "../../../functions/Lenguajes";
...
function Pertenencia() {
  ...
  createEffect(() => {
    ...
    setResult("Concatenación: " + Concatenación(Leng1(), Leng2()));
  });
  ...
  return (
    <VStack spacing="$5" alignItems="stretch" maxW="$96" mx="auto">
      <FormControl>
        ...
        <FormHelperText>Separado por comas. Ej: papa, casa, lata</FormHelperText>
      </FormControl>
      <FormControl>
        ...
        <FormHelperText>Separado por comas. Ej: sol, sal, pez</FormHelperText>
      </FormControl>
